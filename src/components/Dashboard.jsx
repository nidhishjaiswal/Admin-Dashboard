...
//                     <div className="row">
//                         <Card className="satellitemain" name={"Satellite"} totalsales={approvedCount} onClick={() => setShow(!show)}/>
//                         <Card className="vectormain" name={"Vector"} totalsales={(new Intl.NumberFormat('en-IN').format(totalAmount.toFixed(2)))} />
//                         <Card className="onlinemain" name={"Online"} totalsales={filteredData.length} />
...
//                         </div>}
//                         <Card className="vectordets" name={"Free"} totalsales={filteredData.length} />
//                         <Card className="vectordets" name={"Paid"} totalsales={filteredData.length} />
//                         <Card className="onlinedets" name={"Free"} totalsales={filteredData.length} />
//                         <Card className="onlinedets" name={"Paid"} totalsales={filteredData.length} />
